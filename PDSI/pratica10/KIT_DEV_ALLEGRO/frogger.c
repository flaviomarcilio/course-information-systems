/*========================================= Prática com ALLEGRO ========================================
11. frogger.c​: DESAFIO PARA OS FORTES (extra!): alterar o jogo para que este
contenha fases, ou seja, cada vez que o sapo atravessar a rua, você deve recomeçar o
jogo aumentando em 20% a velocidade dos veículos. Quando o sapo morrer, imprima
na tela o número de fases pelo qual o sapo passou.
========================================================================================================*/
...
int main(int argc, char **argv){
   ...
   while(playing) {
	...
	if(collision) {
		al_draw_text(size_32, al_map_rgb(200, 0, 30), SCREEN_W/3, SCREEN_H/2-50, 0, "Perdeu :(");
		sprintf(my_text1, "%d fases concluidas", fase);
		al_draw_text(size_32, al_map_rgb(0, 200, 30), SCREEN_W/3, SCREEN_H/2, 0, my_text1);
	} else {
