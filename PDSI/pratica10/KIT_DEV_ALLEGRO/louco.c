/*====================================== Prática com ALLEGRO ======================================
1. louco.c​: troque a imagem do louco por uma imagem de um míssil. Procure por
imagens de mísseis no ​Google Images​.
2. louco.c​: altere o tempo que a imagem fica na tela para 10 segundos.
===================================================================================================*/
...
display = al_create_display(326, 143);

//inicializa o modulo que permite carregar imagens no jogo
al_init_image_addon();

//carrega a imagem louco.jpg e a atribui aa variavel image
ALLEGRO_BITMAP *image = al_load_bitmap("cruise-missile.png");
