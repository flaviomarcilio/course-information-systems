/*======================================= Prática com ALLEGRO =======================================
3. passaro_andante.c​: aumente a velocidade do pássaro em 10 vezes.
4. passaro_andante.c​: inclua a biblioteca ​math.h​ e modifique a linha 125 do arquivo
para:
  al_draw_bitmap(bird, bird_x, bird_y+30*sin(bird_x/10.0), 0);
5. passaro_andante.c​: faça com que o pássaro se mova em linha reta para a diagonal
superior da tela. Comente as modificações feitas no item anterior.
=====================================================================================================*/
