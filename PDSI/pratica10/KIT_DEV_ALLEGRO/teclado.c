/*======================================= Prática com ALLEGRO ==========================================
8. teclado.c​: não deixe que o valor do campo "minha entrada" seja maior que 150.
9. teclado.c​: permita que o usuário possa usar as setas para modificar os valores.
========================================================================================================*/
