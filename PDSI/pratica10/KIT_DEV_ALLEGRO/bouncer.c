/*====================================== Prática com ALLEGRO ======================================
6. bouncer.c​: troque a cor do ​bouncer​ para branco.
7. bouncer.c​: troque a cor do ​bouncer​ para amarelo toda vez que ele tocar uma parede
lateral da tela e o torne invisível toda vez que ele tocar o teto ou chão da tela. Se o
bouncer ficar parado depois de fazer isso, use a função
   al_set_target_bitmap(al_get_backbuffer(display));
para fazer com que o alvo do programa volte a ser a tela.
===================================================================================================*/
